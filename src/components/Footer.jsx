        ...
        < footer className="bg-white border-t border-gray-100 py-20" >
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <h2 className="text-xl font-bold text-gray-900">Giteer</h2>
                        </div>
                        <p className="text-gray-500 mb-4">Giteer torna mais facil.</p>
                        <div className="flex space-x-4 items-center">
                            <a href="https://wa.me/+257745512288" target="_blank" className="text-gray-400 hover:text-[#d84506] transition-colors">
                                <FaWhatsapp className="w-6 h-6" />
                            </a>
                            <a href="https://github.com/OscarNdodo/giteer" target="_blank" className="text-gray-400 hover:text-[#d84506] transition-colors">
                ...
                <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-500 text-sm">&copy; {new Date().getFullYear()} Giteer. Todos os direitos reservados.</p>
